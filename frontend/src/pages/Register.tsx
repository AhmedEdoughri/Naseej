...
const Register = () => {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-amber-100 dark:from-slate-900 dark:via-slate-950 relative overflow-hidden flex items-center justify-center p-4">
        <div dir="ltr">
          <Header />
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            <div className="space-y-4">
              ...
              <Input
                ...
                disabled={isSubmitting}
                className={
                  i18n.dir() === "rtl" ? "text-right pr-3" : "text-left pl-3"
                }
              />
