...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-amber-50 via-yellow-50 to-amber-100 dark:from-slate-900 dark:via-slate-950">
        <div dir="ltr">
          <Header />
        </div>
        ...
        <div className="flex flex-1 items-center justify-center p-4">
          <div
            className={`w-full max-w-xl relative z-10 transform transition-all duration-1000 ease-out ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
          >
            <div className="bg-white/90 dark:bg-slate-800/80 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-amber-200 dark:border-slate-800 space-y-6 relative overflow-hidden min-h-[500px]">
              <Link
                to="/"
